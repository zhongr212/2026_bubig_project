...
#define BMI088_ACCEL_CONF_MUST_Set 0x80
#define BMI088_ACCEL_BWP_SHFITS 0x4
#define BMI088_ACCEL_OSR4 (0x0 << BMI088_ACCEL_BWP_SHFITS)
#define BMI088_ACCEL_OSR2 (0x1 << BMI088_ACCEL_BWP_SHFITS)
#define BMI088_ACCEL_NORMAL (0x2 << BMI088_ACCEL_BWP_SHFITS)

#define BMI088_ACCEL_ODR_SHFITS 0x0
#define BMI088_ACCEL_12_5_HZ (0x5 << BMI088_ACCEL_ODR_SHFITS)
#define BMI088_ACCEL_25_HZ (0x6 << BMI088_ACCEL_ODR_SHFITS)
#define BMI088_ACCEL_50_HZ (0x7 << BMI088_ACCEL_ODR_SHFITS)
#define BMI088_ACCEL_100_HZ (0x8 << BMI088_ACCEL_ODR_SHFITS)
#define BMI088_ACCEL_200_HZ (0x9 << BMI088_ACCEL_ODR_SHFITS)
#define BMI088_ACCEL_400_HZ (0xA << BMI088_ACCEL_ODR_SHFITS)
#define BMI088_ACCEL_800_HZ (0xB << BMI088_ACCEL_ODR_SHFITS)
#define BMI088_ACCEL_1600_HZ (0xC << BMI088_ACCEL_ODR_SHFITS)

#define BMI088_ACCEL_RANGE 0x41

#define BMI088_ACCEL_RANGE_SHFITS 0x0
#define BMI088_ACCEL_RANGE_3G (0x0 << BMI088_ACCEL_RANGE_SHFITS)
#define BMI088_ACCEL_RANGE_6G (0x1 << BMI088_ACCEL_RANGE_SHFITS)
#define BMI088_ACCEL_RANGE_12G (0x2 << BMI088_ACCEL_RANGE_SHFITS)
#define BMI088_ACCEL_RANGE_24G (0x3 << BMI088_ACCEL_RANGE_SHFITS)

#define BMI088_INT1_IO_CTRL 0x53
#define BMI088_ACCEL_INT1_IO_ENABLE_SHFITS 0x3
#define BMI088_ACCEL_INT1_IO_ENABLE (0x1 << BMI088_ACCEL_INT1_IO_ENABLE_SHFITS)
#define BMI088_ACCEL_INT1_GPIO_MODE_SHFITS 0x2
#define BMI088_ACCEL_INT1_GPIO_PP (0x0 << BMI088_ACCEL_INT1_GPIO_MODE_SHFITS)
#define BMI088_ACCEL_INT1_GPIO_OD (0x1 << BMI088_ACCEL_INT1_GPIO_MODE_SHFITS)
#define BMI088_ACCEL_INT1_GPIO_LVL_SHFITS 0x1
#define BMI088_ACCEL_INT1_GPIO_LOW (0x0 << BMI088_ACCEL_INT1_GPIO_LVL_SHFITS)
#define BMI088_ACCEL_INT1_GPIO_HIGH (0x1 << BMI088_ACCEL_INT1_GPIO_LVL_SHFITS)

#define BMI088_INT2_IO_CTRL 0x54
#define BMI088_ACCEL_INT2_IO_ENABLE_SHFITS 0x3
#define BMI088_ACCEL_INT2_IO_ENABLE (0x1 << BMI088_ACCEL_INT2_IO_ENABLE_SHFITS)
#define BMI088_ACCEL_INT2_GPIO_MODE_SHFITS 0x2
#define BMI088_ACCEL_INT2_GPIO_PP (0x0 << BMI088_ACCEL_INT2_GPIO_MODE_SHFITS)
#define BMI088_ACCEL_INT2_GPIO_OD (0x1 << BMI088_ACCEL_INT2_GPIO_MODE_SHFITS)
#define BMI088_ACCEL_INT2_GPIO_LVL_SHFITS 0x1
#define BMI088_ACCEL_INT2_GPIO_LOW (0x0 << BMI088_ACCEL_INT2_GPIO_LVL_SHFITS)
#define BMI088_ACCEL_INT2_GPIO_HIGH (0x1 << BMI088_ACCEL_INT2_GPIO_LVL_SHFITS)

#define BMI088_INT_MAP_DATA 0x58
#define BMI088_ACCEL_INT2_DRDY_INTERRUPT_SHFITS 0x6
#define BMI088_ACCEL_INT2_DRDY_INTERRUPT (0x1 << BMI088_ACCEL_INT2_DRDY_INTERRUPT_SHFITS)
#define BMI088_ACCEL_INT1_DRDY_INTERRUPT_SHFITS 0x2
#define BMI088_ACCEL_INT1_DRDY_INTERRUPT (0x1 << BMI088_ACCEL_INT1_DRDY_INTERRUPT_SHFITS)
