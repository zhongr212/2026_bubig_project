...
//uint8_t  SBUS_MultiRx_Buf[2][RC_FRAME_LENGTH] __attribute__((section(".ARM.__at_0x24000000")));


__attribute__((section (".RAM_D1"))) uint8_t SBUS_MultiRx_Buf[2][RC_FRAME_LENGTH];
...
/**
  ...
  * @retval none
  */
void Remote_Message_Moniter(Remote_Info_Typedef  *remote_ctrl)//检测是否超时（暂时未使用该标志位）
{
